...
#
#     Subroutine HandleDelayedEvents redefined at Kernel/System/Event/Handler.pm line 67.
#
...
local $Kernel::OM = Kernel::System::ObjectManager->new(
    'Kernel::System::Log' => {
        LogPrefix => 'Znuny-znuny.Daemon.pl',
    },
);
    ...
    while ($DaemonChecker) {
        ...
        for my $Module ( sort keys %DaemonModules ) {
            ...
            if ( !$ChildPID ) {
                ...
                local $Kernel::OM = Kernel::System::ObjectManager->new(
                    'Kernel::System::Log' => {
                        LogPrefix => "Znuny-znuny.Daemon.pl - Daemon $Module",
                    },
                );
