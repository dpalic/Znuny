...
package Kernel::System::CommunicationChannel::Web;
...
our @ObjectDependencies = (
    'Kernel::System::Ticket::Article::Backend::Web',
);

=head1 NAME

Kernel::System::CommunicationChannel::Web - web communication channel class

=head1 DESCRIPTION

This is a class for web communication channel.
...
sub ArticleBackend {
    return $Kernel::OM->Get('Kernel::System::Ticket::Article::Backend::Web');
}
