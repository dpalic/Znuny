...
sub Data {
    ...
    $Self->{Completeness}        = 0.211991094147583;
    ...
    $Self->{Translation} = {
        ...
        'A new database user with limited permissions will be created for this Znuny system.' =>
            'Novi korisnik baze sa ograničenim pravima bit će  kreiran za ovaj Znuny sustav',
        'Repeat Password' => '',
        'Generated password' => '',
        ...
        'After doing so your Znuny is up and running.' => 'Nakon ovoga Vaš Znuny je uključen i radi.',
        ...
        'Znuny Test Page' => 'Znuny test stranica',
        'Unlock' => 'Otključano',
        'Welcome %s %s' => '',
        'Counter' => 'Brojač',
        ...
        'Resend is not possible for this article!' => 'Ponovno slanje nije moguće za ovaj članak!',
