...
sub Data {
    ...
    $Self->{Completeness}        = 0.234976152623211;
    ...
    $Self->{Translation} = {
        ...
        'To be able to use Znuny you have to enter the following line in your command line (Terminal/Shell) as root.' =>
            'Abyste mohli používat Znuny, musíte zadat následující řádek do Vašeho příkazového řádku (Terminal/Shell) jako root.',
        'Restart your webserver' => 'Restartujte Váš webserver',
        'After doing so your Znuny is up and running.' => 'Po dokončení následujících operací je Váš Znuny spuštěn a poběží',
        ...
        'Znuny Test Page' => 'Testovací Znuny stránka',
        'Unlock' => 'Odemknout',
        'Welcome %s %s' => '',
        'Counter' => 'Počítadlo',
        ...
        'ACLs could not be Imported due to a unknown error, please check Znuny logs for more information' =>
            'Z důvodu neznámé chyby ACL nemohly být naimportovány, pro více informací prosím zkontrolujte logy Znuny',
        ...
        'Znuny as provider' => 'Znuny jako poskytovatel',
        'Operations' => '',
        'Znuny as requester' => 'Znuny jako žadatel',
        'Invokers' => '',
        ...
        'Resend is not possible for this article!' => 'Opětovné odeslání tohoto článku není možné!',
        ...
        'Install Znuny' => 'Instalovat Znuny',
        'Intro' => 'Úvod',
        ...
        'Znuny Daemon is not running.' => 'Znuny plánovač není spuštěn.',
        ...
        'Znuny Disk Partition' => 'Znuny diskový oddíl',

        # Perl Module: Kernel/System/SupportDataCollector/Plugin/OS/DiskSpace.pm
        'Disk Usage' => 'Využití disku',
        'The partition where Znuny is located is almost full.' => 'Particie kde je umístněno Znuny je téměř plná.',
        'The partition where Znuny is located has no disk space problems.' =>
            'Na particii, kde je nainstalováno Znuny není problém s diskovým prostorem.',
        ...
        'The file system on your Znuny partition is not writable.' => 'Na souborový systém na vaší Znuny particii není možné zapisovat.',
